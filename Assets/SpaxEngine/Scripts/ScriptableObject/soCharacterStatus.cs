...
namespace FightingGameEngine.Data
{
    ...
    public class soCharacterStatus : ScriptableObject
    {
        ...
        public ResourceData CurrentResources { get { return this.m_currentResources; } set { this.m_currentResources = value; } }
        ...
        //no set, we determine whether we check the state here
        public bool CheckState { get { return this.m_checkState; } }
        ...
        {
            this._inputRecorder.BufferInput(bufferLeniency);
        }
